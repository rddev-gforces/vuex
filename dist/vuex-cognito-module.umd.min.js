(function (e, t) {
  "object" === typeof exports && "object" === typeof module ? module.exports = t() : "function" === typeof define && define.amd ? define([], t) : "object" === typeof exports ? exports["vuex-cognito-module"] = t() : e["vuex-cognito-module"] = t();
  ...
  return function (e) {
        ...
        var n,
          ...
          buffer: {
            ...
            concat: function (e) {
              ...
              for (o = i.buffer.alloc(r), t = 0; t < e.length; t++) e[t].copy(o, n), n += e[t].length;
          ...
          defer: function (e) {
            "object" === typeof t && "function" === typeof t.nextTick ? t.nextTick(e) : "function" === typeof setImmediate ? setImmediate(e) : setTimeout(e, 0);
          },
          ...
          getProfilesFromSharedConfig: function (e, t) {
            ...
            }), s = 0, a = Object.keys(n); s < a.length; s++) r[a[s]] = n[a[s]];

            for (s = 0, a = Object.keys(o); s < a.length; s++) r[a[s]] = o[a[s]];
    ...
    "0857": function (e, t, r) {
      ...
      function l(e, t) {
        ...
        while (i) i.nodeName === n && r.push(a(i, t.member)), i = i.nextElementSibling;
      ...
      (function (e) {
        ...
        function n(e, i) {
          ...
          if (!0 === t(e)) {
            ...
            for (var s = 0; s < e.length; s++) if (!1 === n(e[s], i[s])) return !1;
          ...
          if (!0 === r(e)) {
            ...
            for (var c in i) if (hasOwnProperty.call(i, c) && !0 !== a[c]) return !1;
        ...
        $.prototype = {
          tokenize: function (e) {
            ...
            while (this._current < e.length) if (X(e[this._current])) t = this._current, r = this._consumeUnquotedIdentifier(e), i.push({
              type: v,
              value: r,
              start: t
          ...
          _consumeUnquotedIdentifier: function (e) {
            ...
            while (this._current < e.length && Z(e[this._current])) this._current++;
          ...
          _consumeNumber: function (e) {
            ...
            while (Y(e[this._current]) && this._current < r) this._current++;
        ...
        Q[y] = 0, Q[v] = 0, Q[b] = 0, Q[w] = 0, Q[S] = 0, Q[C] = 0, Q[_] = 0, Q[E] = 0, Q[I] = 0, Q[T] = 0, Q[x] = 1, Q[P] = 2, Q[R] = 3, Q[k] = 5, Q[U] = 5, Q[O] = 5, Q[D] = 5, Q[N] = 5, Q[M] = 5, Q[L] = 9, Q[F] = 20, Q[j] = 21, Q[q] = 40, Q[B] = 45, Q[V] = 50, Q[H] = 55, Q[z] = 60, ee.prototype = {
          ...
          expression: function (e) {
            ...
            while (e < Q[n]) this._advance(), r = this.led(n, r), n = this._lookahead(0);
          ...
          nud: function (e) {
            ...
            switch (e.type) {
              ...
              case z:
                ...
                while (this._lookahead(0) !== S) this._lookahead(0) === I ? (n = {
                  type: I
          ...
          led: function (e, t) {
            ...
            switch (e) {
              ...
              case z:
                ...
                while (this._lookahead(0) !== S) this._lookahead(0) === I ? (i = {
                  type: I
          ...
          visit: function (e, s) {
            ...
            switch (e.type) {
              ...
              case "Subexpression":
                for (c = this.visit(e.children[0], s), m = 1; m < e.children.length; m++) if (c = this.visit(e.children[1], c), null === c) return null;
              ...
              case "Slice":
                ...
                var v = e.children.slice(0),
                    ...
                    S = b[1],
                    C = b[2];
                if (c = [], C > 0) for (m = w; m < S; m += C) c.push(s[m]);else for (m = w; m > S; m += C) c.push(s[m]);
                return c;
              ...
              case "Projection":
                ...
                for (g = [], m = 0; m < A.length; m++) u = this.visit(e.children[1], A[m]), null !== u && g.push(u);
              ...
              case "ValueProjection":
                ...
                for (m = 0; m < _.length; m++) u = this.visit(e.children[1], _[m]), null !== u && g.push(u);
              ...
              case "FilterProjection":
                ...
                for (m = 0; m < A.length; m++) a = this.visit(e.children[2], A[m]), i(a) || E.push(A[m]);

                for (var R = 0; R < E.length; R++) u = this.visit(e.children[1], E[R]), null !== u && P.push(u);
              ...
              case L:
                ...
                for (m = 0; m < F.length; m++) u = F[m], t(u) ? j.push.apply(j, u) : j.push(u);
              ...
              case "MultiSelectList":
                ...
                for (g = [], m = 0; m < e.children.length; m++) g.push(this.visit(e.children[m], s));
              ...
              case "MultiSelectHash":
                ...
                for (g = {}, m = 0; m < e.children.length; m++) q = e.children[m], g[q.name] = this.visit(q.value, s);
              ...
              case "Function":
                ...
                for (m = 0; m < e.children.length; m++) B.push(this.visit(e.children[m], s));
          ...
          _functionReverse: function (e) {
            ...
            if (t === c) {
              for (var r = e[0], n = "", i = r.length - 1; i >= 0; i--) n += r[i];
          ...
          _functionMax: function (e) {
            if (e[0].length > 0) {
              ...
              for (var r = e[0], n = r[0], i = 1; i < r.length; i++) n.localeCompare(r[i]) < 0 && (n = r[i]);
          ...
          _functionMin: function (e) {
            if (e[0].length > 0) {
              ...
              for (var r = e[0], n = r[0], i = 1; i < r.length; i++) r[i].localeCompare(n) < 0 && (n = r[i]);
          ...
          _functionNotNull: function (e) {
            for (var t = 0; t < e.length; t++) if (this._getTypeName(e[t]) !== d) return e[t];
          ...
          _functionSortBy: function (e) {
            ...
            for (var o = this, s = [], u = 0; u < t.length; u++) s.push([u, t[u]]);
          ...
          _functionMaxBy: function (e) {
            for (var t, r, n = e[1], i = e[0], o = this.createKeyFunction(n, [a, c]), s = -1 / 0, u = 0; u < i.length; u++) r = o(i[u]), r > s && (s = r, t = i[u]);
      ...
      o.prototype.parse = function (e, t, r) {
        ...
        if (!v[A] && (E || A && !b[A])) {
          ...
          if (!k) for (var U = this.hostname.split(/\./), O = (P = 0, U.length); P < O; P++) {
            ...
            if (D && !D.match(g)) {
              for (var N = "", M = 0, L = D.length; M < L; M++) D.charCodeAt(M) > 127 ? N += "x" : N += D[M];
        ...
        for (var I = A.slice(-1)[0], T = (r.host || e.host || A.length > 1) && ("." === I || ".." === I) || "" === I, x = 0, P = A.length; P >= 0; P--) I = A[P], "." === I ? A.splice(P, 1) : ".." === I ? (A.splice(P, 1), x++) : x && (A.splice(P, 1), x--);

        if (!S && !C) for (; x--; x) A.unshift("..");
        ...
        return function () {
          ...
          i.Base64 = {
            stringify: function (e) {
              ...
              for (var i = [], o = 0; o < r; o += 3) for (var s = t[o >>> 2] >>> 24 - o % 4 * 8 & 255, a = t[o + 1 >>> 2] >>> 24 - (o + 1) % 4 * 8 & 255, u = t[o + 2 >>> 2] >>> 24 - (o + 2) % 4 * 8 & 255, c = s << 16 | a << 8 | u, l = 0; l < 4 && o + .75 * l < r; l++) i.push(n.charAt(c >>> 6 * (3 - l) & 63));
    ...
    "146b": function (e, t, r) {
      ...
      e.exports = {
        ...
        getSigningKey: function (e, t, r, u, c) {
      ...
      (function (e) {
        var r = [{
          ...
          return t.isEmpty = function (e) {
            ...
            for (var e = "", t = "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ", r = 32; r > 0; r -= 1) e += t[Math.floor(Math.random() * t.length)];
    ...
    "1fb5": function (e, t, r) {
      ...
      function d(e, t, r) {
        for (var n, i = [], o = t; o < r; o += 3) n = (e[o] << 16 & 16711680) + (e[o + 1] << 8 & 65280) + (255 & e[o + 2]), i.push(p(n));
      ...
      function s(e, t, r, i) {
        ...
        if (n.each(r.members, function (e, t) {
          ...
          n.arrayEach(Object.keys(s).sort(), function (e) {
            ...
            for (var t = 0; t < s[e].length; t++) u.push(n.uriEscape(String(e)) + "=" + s[e][t]);
          }), o += u.join("&");
        }
    ...
    3022: function (e, t, r) {
      (function (e) {
        ...
        t.format = function (e) {
          ...
          }), u = n[r]; r < o; u = n[++r]) b(u) || !I(u) ? s += " " + u : s += " " + a(u);
        ...
        function d(e, t, r, n, i) {
          for (var o = [], s = 0, a = t.length; s < a; ++s) N(t, String(s)) ? o.push(g(e, t, r, n, String(s), !0)) : o.push("");
    ...
    4461: function (e, t) {
      e.exports = {
        ...
        session: (e = {}) => "session" in e && 0 !== Object.keys(e.session).length && e.session,
        userSub: (e = {}) => {
          return e.user && e.user.attributes ? e.user.attributes.sub : !(!e.user || !e.user.userSub) && e.user.userSub;
        },
        username: (e = {}) => !(!e.user || !e.user.user) && e.user.user.username,
        userAttributes: (e = {}) => !(!e.user || !e.user.attributes) && e.user.attributes,
        userGroups: (e = {}) => !!(e.session && e.session.accessToken && e.session.accessToken.payload && e.session.accessToken.payload["cognito:groups"]) && e.session.accessToken.payload["cognito:groups"]
      };
    },
    "4a5e": function (e, t) {
      function r(e) {
    ...
    "4f40": function (e, t, r) {
      ...
      function o(e, t, r, n, o) {
        ...
        for (var a in e) Object.prototype.hasOwnProperty.call(e, a) && (i.call(s, a, e[a], r, n), o && o(a, e[a]));
      }
        ...
        (function () {
          ...
          s.HMAC = n.extend({
            init: function (e, t) {
              ...
              for (var i = this._oKey = t.clone(), s = this._iKey = t.clone(), a = i.words, u = s.words, c = 0; c < r; c++) a[c] ^= 1549556828, u[c] ^= 909522486;
    ...
    "7e25": function (e, t, r) {
      ...
      Object.defineProperty(u, "defaultMaxListeners", {
        ...
        if (t = r[e], "function" === typeof t) this.removeListener(e, t);else if (void 0 !== t) for (n = t.length - 1; n >= 0; n--) this.removeListener(e, t[n]);
        return this;
      ...
      (function (e) {
        ...
        c.setupStates = function () {
          ...
          emitEvent: function (e, r, n) {
            "function" === typeof r && (n = r, r = null), n || (n = function () {}), r || (r = this.eventParameters(e, this.response));
      ...
      (function (t, n) {
        ...
        return function (t) {
          ...
          (function () {
            ...
            while (i < 64) e(n) && (i < 8 && (a[i] = r(t.pow(n, .5))), u[i] = r(t.pow(n, 1 / 3)), i++), n++;
          })();
      ...
      (function (e, n) {
        ...
        (function (o) {
          ...
          function T(e) {
            ...
            while (i < o) t = e.charCodeAt(i++), t >= 55296 && t <= 56319 && i < o ? (r = e.charCodeAt(i++), 56320 == (64512 & r) ? n.push(((1023 & t) << 10) + (1023 & r) + 65536) : (n.push(t), i--)) : n.push(t);
          ...
          function k(e, t, r) {
            ...
            for (e = r ? C(e / p) : e >> 1, e += C(e / t); e > S * h >> 1; n += c) e = C(e / S);
          ...
          function U(e) {
            ...
            for (r = e.lastIndexOf(m), r < 0 && (r = 0), n = 0; n < r; ++n) e.charCodeAt(n) >= 128 && _("not-basic"), v.push(e.charCodeAt(n));
          ...
          function O(e) {
            ...
            for (e = T(e), b = e.length, t = g, r = 0, o = d, s = 0; s < b; ++s) v = e[s], v < 128 && I.push(A(v));

            n = i = I.length, i && I.push(m);

            while (n < b) {
              for (a = u, s = 0; s < b; ++s) v = e[s], v >= t && v < a && (a = v);

              for (w = n + 1, a - t > C((u - r) / w) && _("overflow"), r += (a - t) * w, t = a, s = 0; s < b; ++s) if (v = e[s], v < t && ++r > u && _("overflow"), v == t) {
                for (f = r, p = c;; p += c) {
    ...
    "9f86": function (e, t, r) {
      ...
      function s(e) {
        ...
        for (t = 7; t > -1; t--) if (e[t]++, 0 !== e[t]) break;
      }
    ...
    b639: function (e, t, r) {
      ...
      (function (e) {
        ...
        function p(e, t) {
          if (h(t), e = u(e, t < 0 ? 0 : 0 | v(t)), !c.TYPED_ARRAY_SUPPORT) for (var r = 0; r < t; ++r) e[r] = 0;
          return e;
        }
        ...
        t.Buffer = c, t.SlowBuffer = b, t.INSPECT_MAX_BYTES = 50, c.TYPED_ARRAY_SUPPORT = void 0 !== e.TYPED_ARRAY_SUPPORT ? e.TYPED_ARRAY_SUPPORT : s(), t.kMaxLength = a(), c.poolSize = 8192, c._augment = function (e) {
          ...
          for (var o = i - n, s = r - t, a = Math.min(o, s), u = this.slice(n, i), l = e.slice(t, r), h = 0; h < a; ++h) if (u[h] !== l[h]) {
            o = u[h], s = l[h];
            break;
          }
        ...
        function D(e) {
          ...
          while (n < t) r += String.fromCharCode.apply(String, e.slice(n, n += O));
        ...
        c.prototype.slice = function (e, t) {
          ...
          while (++s < r && (o *= 256)) this[t + s] = e / o & 255;
          ...
          while (++o < r && (s *= 256)) e < 0 && 0 === a && 0 !== this[t + o - 1] && (a = 1), this[t + o] = (e / s >> 0) - a & 255;
    ...
    c56b: function (e, t, r) {
      ...
      e.exports = a, a.BLOCK_SIZE = o, a.prototype.update = function (e) {
        ...
        while (i > 0) this.buffer.setUint8(this.bufferLength++, t[r++]), i--, this.bufferLength === o && (this.hashBuffer(), this.bufferLength = 0);
        ...
        if (!this.finished) {
          ...
          if (r.setUint8(this.bufferLength++, 128), n % o >= o - 8) {
            for (var c = this.bufferLength; c < o; c++) r.setUint8(c, 0);

            this.hashBuffer(), this.bufferLength = 0;
          }

          for (c = this.bufferLength; c < o - 8; c++) r.setUint8(c, 0);
        ...
        for (c = 0; c < 4; c++) l.setUint32(4 * c, this.state[c], !0);
    ...
    ca75: function (e, t, r) {
      ...
      e.exports = c, c.BLOCK_SIZE = o, c.prototype.update = function (e) {
        ...
        while (r > 0) this.buffer[this.bufferLength++] = e[t++], r--, this.bufferLength === o && (this.hashBuffer(), this.bufferLength = 0);
        ...
        if (!this.finished) {
          ...
          if (r.setUint8(this.bufferLength++, 128), i % o >= o - 8) {
            for (var a = this.bufferLength; a < o; a++) r.setUint8(a, 0);

            this.hashBuffer(), this.bufferLength = 0;
          }

          for (a = this.bufferLength; a < o - 8; a++) r.setUint8(a, 0);
        ...
        for (a = 0; a < 8; a++) u[4 * a] = this.state[a] >>> 24 & 255, u[4 * a + 1] = this.state[a] >>> 16 & 255, u[4 * a + 2] = this.state[a] >>> 8 & 255, u[4 * a + 3] = this.state[a] >>> 0 & 255;
    ...
    f8e2: function (e, t, r) {
      ...
      function i(e, t) {
        ...
        for (var i = 0; i < e.BLOCK_SIZE; i++) r[i] ^= 54, n[i] ^= 92;

        this.hash.update(r), this.outer.update(n);

        for (i = 0; i < r.byteLength; i++) r[i] = 0;
      }
    ...
    fb15: function (e, t, r) {
      ...
      var V = r("1f3a"),
        ...
        Object.defineProperty(e.prototype, "serviceWorker", {
          ...
          for (var t = "=".repeat((4 - e.length % 4) % 4), r = (e + t).replace(/\-/g, "+").replace(/_/g, "/"), n = window.atob(r), i = new Uint8Array(n.length), o = 0; o < n.length; ++o) i[o] = n.charCodeAt(o);
      ...
      for (lt = "0".charCodeAt(0), ht = 0; ht <= 9; ++ht) pt[lt++] = ht;

      for (lt = "a".charCodeAt(0), ht = 10; ht < 36; ++ht) pt[lt++] = ht;
      ...
      function St(e) {
        ...
        if (s-- > 0) {
          ...
          while (s >= 0) a < t ? (r = (this[s] & (1 << a) - 1) << t - a, r |= this[--s] >> (a += this.DB - t)) : (r = this[s] >> (a -= t) & n, a <= 0 && (a += this.DB, --s)), r > 0 && (i = !0), i && (o += dt(r));
        }
      ...
      function kt(e, t) {
        ...
        while (r < i) n += this[r] - e[r], t[r++] = n & this.DM, n >>= this.DB;

        if (e.t < this.t) {
          n -= e.s;

          while (r < this.t) n += this[r], t[r++] = n & this.DM, n >>= this.DB;

          n += this.s;
        } else {
          n += this.s;

          while (r < e.t) n -= e[r], t[r++] = n & this.DM, n >>= this.DB;
      ...
      function Xt(e, t, r) {
        ...
        if (a[1] = s.convert(this), n > 1) {
          ...
          while (u <= l) a[u] = rt(), s.mulTo(h, a[u - 2], a[u]), u += 2;
        }
        ...
        while (d >= 0) {
          ...
          if ((i -= u) < 0 && (i += this.DB, --d), g) a[f].copyTo(o), g = !1;else {
            while (u > 1) s.sqrTo(o, m), s.sqrTo(m, o), u -= 2;

            u > 0 ? s.sqrTo(o, m) : (p = o, o = m, m = p), s.mulTo(m, a[f], o);
          }

          while (d >= 0 && 0 == (e[d] & 1 << i)) s.sqrTo(o, m), p = o, o = m, m = p, --i < 0 && (i = this.DB - 1, --d);
        }
      ...
      var Xr,
        ...
        return e.prototype.setItem = function (e, t) {
          ...
          for (t = 0; t < e.length; ++t) Gr["remove"](e[t]);
        ...
        return e.prototype.oauthSignIn = function (e, t, r, n, i, s) {
          void 0 === e && (e = "code"), void 0 === i && (i = o.Cognito);
                ...
                case 0:
                  return t = (Object($r["parse"])(e).query || "").split("&").map(function (e) {
                    ...
                    var r,
                        n = t[0],
                        i = t[1];
                    return sn(sn({}, e), (r = {}, r[n] = i, r));
                  }, {
                    code: void 0
                  }).code, t ? (r = "https://" + this._config.domain + "/oauth2/token", fn("codeFlow", {}, "Retrieving tokens from " + r), n = p(this._config) ? this._cognitoClientId : this._config.clientID, i = p(this._config) ? this._config.redirectSignIn : this._config.redirectUri, o = on(), s = sn({
          ...
          return an(this, void 0, void 0, function () {
            ...
            return un(this, function (u) {
              switch (u.label) {
                case 0:
                  if (u.trys.push([0, 5,, 6]), t = e ? sn(sn({}, (Object($r["parse"])(e).hash || "#").substr(1).split("&").map(function (e) {
                    return e.split("=");
                  }).reduce(function (e, t) {
                    var r = t[0],
                        n = t[1];
                ...
                case 1:
                  return [2, sn.apply(void 0, [sn.apply(void 0, o.concat([u.sent()])), {
                    state: i
                  }])];
                ...
                case 3:
                  return [2, sn.apply(void 0, [sn.apply(void 0, s.concat([u.sent()])), {
                    state: i
                  }])];
          ...
          for (var t = "", r = e, n = "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"; r > 0; --r) t += n[Math.round(Math.random() * (n.length - 1))];
          ...
          var t = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-._~",
              r = new Uint8Array(e);
          if ("undefined" !== typeof window && window.crypto) window.crypto.getRandomValues(r);else for (var n = 0; n < e; n += 1) r[n] = Math.random() * t.length | 0;
      ...
      var Pn = function () {
        ...
        return e.prototype.getModuleName = function () {
          ...
          if (e && "string" === typeof e) {
            ...
            if (!e || "object" !== typeof e) return this.rejectAuthError(s.SignUpError);
            o = e["username"], a = e["password"], e && e.clientMetadata ? i = e.clientMetadata : this._config.clientMetadata && (i = this._config.clientMetadata);
            var f = e["attributes"];
          ...
          return o ? a ? (En.debug("signUp attrs:", u), En.debug("signUp validation data:", c), new Promise(function (e, r) {
            t.userPool.signUp(o, a, u, c, function (t, n) {
              t ? (xn("signUp_failure", t, o + " failed to signup"), r(t)) : (xn("signUp", n, o + " has signed up successfully"), e(n));
            }, i);
          })) : this.rejectAuthError(s.EmptyPassword) : this.rejectAuthError(s.EmptyUsername);
        }, e.prototype.confirmSignUp = function (e, t, r) {
          if (!this.userPool) return this.rejectNoUserPool();
          if (!e) return this.rejectAuthError(s.EmptyUsername);
          if (!t) return this.rejectAuthError(s.EmptyCode);
          var n,
              i = this.createCognitoUser(e),
              o = !r || "boolean" !== typeof r.forceAliasCreation || r.forceAliasCreation;
          return r && r.clientMetadata ? n = r.clientMetadata : this._config.clientMetadata && (n = this._config.clientMetadata), new Promise(function (e, r) {
            i.confirmRegistration(t, o, function (t, n) {
              t ? r(t) : e(n);
            }, n);
          });
          ...
          if ("string" === typeof e) n = e, i = t;else {
            if (!d(e)) return this.rejectAuthError(s.InvalidUsername);
            "undefined" !== typeof t && En.warn("The password should be defined under the first parameter object!"), n = e.username, i = e.password, o = e.validationData;
          }
          if (!n) return this.rejectAuthError(s.EmptyUsername);
          var a = new We({
            Username: n,
            Password: i,
            ValidationData: o,
          ...
          return An(this, void 0, void 0, function () {
            ...
            return _n(this, function (c) {
              switch (c.label) {
                ...
                case 1:
                  switch (r = c.sent(), n = null, i = null, o = t, o) {
                    case "TOTP":
                      return [3, 2];
                ...
                case 5:
                  ...
                  if ("SMS_MFA" === u) n = {
                    ...
                    if ("SOFTWARE_TOKEN_MFA" !== u) return [2, this.rejectAuthError(s.InvalidMFA)];
                    i = {
                      PreferredMfa: !1,
                      Enabled: !1
                    };
                ...
                case 6:
                  return En.debug("no validmfa method provided"), [2, this.rejectAuthError(s.NoMFA)];
          ...
          var i = this;
          if (void 0 === n && (n = this._config.clientMetadata), !t) return this.rejectAuthError(s.EmptyCode);
          var o = this;
                ...
                return An(i, void 0, void 0, function () {
                  ...
                  return _n(this, function (i) {
                    switch (i.label) {
                      ...
                      case 5:
                        return o.user = e, xn("signIn", e, e + " has signed in"), s(e), [7];
          ...
          var i = this;
          if (void 0 === n && (n = this._config.clientMetadata), !t) return this.rejectAuthError(s.EmptyPassword);
          var o = this;
          return new Promise(function (s, a) {
            e.completeNewPasswordChallenge(t, r, {
              ...
              mfaRequired: function (t, r) {
                En.debug("signIn MFA required"), e["challengeName"] = t, e["challengeParam"] = r, s(e);
              },
              mfaSetup: function (t, r) {
                En.debug("signIn mfa setup", t), e["challengeName"] = t, e["challengeParam"] = r, s(e);
              }
            }, n);
          });
        }, e.prototype.sendCustomChallengeAnswer = function (e, t, r) {
          var n = this;
          if (void 0 === r && (r = this._config.clientMetadata), !this.userPool) return this.rejectNoUserPool();
          if (!t) return this.rejectAuthError(s.EmptyChallengeResponse);
          ...
          return new Promise(function (o, s) {
            i.userSession(e).then(function (i) {
              for (var a in t) if ("sub" !== a && a.indexOf("_verified") < 0) {
                var u = {
                  Name: a,
                  Value: t[a]
                };
          ...
          }) : (En.debug("the user is null"), this.rejectAuthError(s.NoUserSession));
          ...
          }) : this.rejectAuthError(s.EmptyCode);
          ...
          if (!e) return this.rejectAuthError(s.EmptyUsername);
          if (!t) return this.rejectAuthError(s.EmptyCode);
          if (!r) return this.rejectAuthError(s.EmptyPassword);
          ...
          return !e || e.userPoolId && e.identityPoolId ? s.NoConfig : s.MissingAuthConfig;
      ...
      var Dn = On,
        ...
        fetchSession: ({
          ...
          Dn.currentSession().then(n => {
            Dn.currentUserPoolUser().then(r => {
              e("setUser", r), t(n);
            }).catch(r);
          }).catch(r);
        }),
        ...
        signInUser: ({
          ...
          Dn.signIn(t.username, t.password).then(t => {
            e("setUser", t), r(t);
          }).catch(n);
        }),
        answerCustomChallenge: ({
          ...
          Dn.sendCustomChallengeAnswer(t.user, t.answer).then(t => {
            e("setUser", t), r(t);
          }).catch(n);
        }),
        registerUser: ({
        ...
        confirmUser: (e, t) => new Promise((e, r) => {
          Dn.confirmSignUp(t.username, t.code).then(e).catch(r);
        }),
        resendConfirmation: (e, t) => new Promise((e, r) => {
          Dn.resendSignUp(t.username).then(e).catch(r);
        }),
        forgotPassword: (e, t) => new Promise((e, r) => {
          Dn.forgotPassword(t.username).then(e).catch(r);
        }),
        changePassword: (e, t) => new Promise((e, r) => {
        ...
        signOut: ({
          ...
          t.isLoggedIn || n(new Error("User not logged in.")), Dn.signOut().then(t => {
            e("setUser", {}), r(t);
        ...
        init({
          ...
          if (!["userPoolId", "userPoolWebClientId", "region"].every(e => Boolean(t[e]))) throw new Error("userPoolId, userPoolWebClientId and region are required in the config object.");
          Be.configure({
            Auth: t
          });
        }
